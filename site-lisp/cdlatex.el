...
(defconst cdlatex-command-alist-default
  '(
    ...
    ("lab"       "Insert automatic label at point"     "" reftex-label nil t t)
    ("cte"       "Make a citation interactively"     "" reftex-citation nil t nil)
;;    ("cite{"       "Make a citation interactively"     "cite{" reftex-citation nil t nil)
    ("beg"       "Complete an env name and insert template"     "" cdlatex-environment nil t t)
